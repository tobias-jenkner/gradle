...
public class DefaultInMemoryCachingRuleExecutor<KEY, DETAILS, RESULT> implements CachingRuleExecutor<KEY, DETAILS, RESULT> {
    ...
    private final Transformer<Serializable, KEY> keySerializer;

    public DefaultInMemoryCachingRuleExecutor(ValueSnapshotter snapshotter, Transformer<Serializable, KEY> keySerializer) {
